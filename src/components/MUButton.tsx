...
export const MUButton = ({ 
  ...
  const baseClasses = "rounded-[54px] px-5 py-3 md:px-6 md:py-3.5 font-medium text-sm md:text-base leading-[150%] inline-flex items-center justify-center gap-1.5 transition-all duration-300 cursor-pointer";
